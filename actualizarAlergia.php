...
// El resto de tu código PHP para procesar la solicitud PUT
...
if (empty($id) || empty($nombre) || empty($descripcion)) {
    $response = ['error' => 'El ID, nombre y descripción son obligatorios.'];
...
$sql = "UPDATE alergias SET Nombre = ?, Descripcion = ? WHERE ID = ?";
