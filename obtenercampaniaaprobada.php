...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    try {
        // Preparar la consulta SQL para obtener las campañas aprobadas
        $sql = "SELECT * FROM campanias WHERE estado = 'aprobada'";
        ...
        if ($result->num_rows > 0) {
            ...
            echo json_encode(array("success" => false, "message" => "No se encontraron campañas aprobadas."));
        }
    } catch (Exception $e) {
